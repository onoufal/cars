...
var car = '<img src="car.jpg" alt="">'
// var numCars = 0

var numCars = prompt("How many cars do you want?")

while (numCars < 3 || numCars > 9) {
    numCars = prompt("How many cars do you want? choose between 3 and 9")
}
